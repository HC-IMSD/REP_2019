...
<!--	<xsl:variable name="input-text" as="xs:string" select="unparsed-text('./ip400.css', 'iso-8859-1')"/>-->
	<xsl:template match="/">
		<html>
			<head>
							...
							<div class="col-xs-12 form-group">
								...
								<div class="form-group">
									<ul class="nav nav-tabs">
										<li tabindex="0" class="active" id="tab0"><a href="#tabpanel0"><xsl:call-template name="hp-label"><xsl:with-param name="code" select="'FORMULATIONS'"/></xsl:call-template></a>
										</li>
									</ul>
									<div class="tabpanels">
													...
													<tr>
														<td colspan="3"> 
															...
															<fieldset>
																...
																<div class="row">
																	<div class="col-md-6">
																	<label><xsl:call-template name="hp-label"><xsl:with-param name="code" select="'MATERIAL_NAME'"/></xsl:call-template>:&#160;<span style="font-weight: normal;" class="mouseHover"><xsl:value-of select="./ingredient_name"/></span></label>
																	</div>
																</div>
																<div class="row">
																	<div class="col-md-3">
															...
															<fieldset>
																...
																<div class="row">
																	<span class="col-md-6 mouseHover"><xsl:value-of select="./container_details/container_type"/></span>
																</div>
																<div class="row">
																	<div class="col-md-6">
																...
																<div class="row">
																	<span class="col-md-6 mouseHover"><xsl:value-of select="./container_details/package_size"/></span>
																</div>
																<div class="row">
																	<div class="col-md-6">
																		<label><xsl:call-template name="hp-label"><xsl:with-param name="code" select="'SHELF_LIFE'"/></xsl:call-template>:&#160;
																		<span style="font-weight: normal;" class="mouseHover"><xsl:value-of select="./container_details/shelf_life_number"/></span>&#160;
																		<span style="font-weight: normal;" class="mouseHover"><xsl:choose><xsl:when test="$language = 'fra'"><xsl:apply-templates select="./container_details/shelf_life_unit/@label_fr" /></xsl:when><xsl:otherwise><xsl:apply-templates select="./container_details/shelf_life_unit/@label_en" /></xsl:otherwise></xsl:choose></span>
																		</label>
																	</div>
																</div>
																<div class="row">
																	<div class="col-md-6">
																		...
																		<span style="font-weight: normal;" class="mouseHover"><xsl:value-of select="./container_details/temperature_min"/></span>&#160;&#160;
																		<xsl:call-template name="hp-label"><xsl:with-param name="code" select="'TO'"/></xsl:call-template>:&#160;
																		<span style="font-weight: normal;" class="mouseHover"><xsl:value-of select="./container_details/temperature_max"/></span>&#160;
									...
									<ul class="nav nav-tabs">
										<li tabindex="1" id="tab1"><a href="#tabpanel1"><xsl:call-template name="hp-label"><xsl:with-param name="code" select="'APPENDIX4'"/></xsl:call-template></a>
										</li>
									</ul>
										<div id="tabpanel1">
											<table class="table dataTable table-bordered table-hover table-condensed table-striped">
