...
var cspRootTitles_fr = {
    mainHeading: "Formulaire de demande de certificat de protection supplémentaire (CPS)",
    title: 'Formulaire de demande de certificat de protection supplémentaire de Santé Canada'
...
gulp.task('dev-csp-htmlBuild', gulp.series('dev-csp-clean', 'dev-global-create-src-template', 'dev-csp-copyData', 'dev-csp-copySrc', 'dev-csp-copyLib', 'dev-csp-createRootJS', 'dev-csp-createResources', function () {
    ...
    var deploy = deployType.dev;
    var englishHtmlName="certificate-supplementary-protection-form-2020-2021.html";
    var frenchHtmlName="formulaire-certificat-protection-supplementaire-2020-2021.html";
...
gulp.task('prod-build-allForms', gulp.series(
    ...
    'prod-dossier-allFormsCreate', function(done) {
        done();
    }));
